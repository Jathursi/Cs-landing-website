...
function Gallery() {
  ...
  return (
    <div className="p-4">
      ...
      {event ? (
        <div>
          <h2 className="text-2xl font-semibold text-center mb-4">{event.event}</h2>
  ...
  >
    {/* Previous Button */}
    <button
      className="absolute top-1/2 left-4 p-2 text-white text-5xl font-bold transform -translate-y-1/2 z-50"
    ...
    {/* Next Button */}
    <button
      className="absolute top-1/2 right-4 p-2 text-white text-5xl font-bold transform -translate-y-1/2 z-50"
